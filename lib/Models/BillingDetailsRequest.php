 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BillingDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BillingDetailsRequest';
    ...
    public function setPhoneNumber($phoneNumber)
    {
        if (!is_null($phoneNumber) && (mb_strlen($phoneNumber) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling BillingDetailsRequest., must be smaller than or equal to 25.');
        }
    ...
    public function setEmailAddress($emailAddress)
    {
        if (!is_null($emailAddress) && (mb_strlen($emailAddress) > 254)) {
            throw new \InvalidArgumentException('invalid length for $emailAddress when calling BillingDetailsRequest., must be smaller than or equal to 254.');
        }
