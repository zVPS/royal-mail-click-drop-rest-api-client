...
class TagRequest implements ModelInterface, ArrayAccess
{
    ...
    public function setKey($key)
    {
        if (!is_null($key) && (mb_strlen($key) > 100)) {
            throw new \InvalidArgumentException('invalid length for $key when calling TagRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 100)) {
            throw new \InvalidArgumentException('invalid length for $value when calling TagRequest., must be smaller than or equal to 100.');
        }
