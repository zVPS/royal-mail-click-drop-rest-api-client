...
/**
 * SenderDetailsRequest Class Doc Comment
 *
 * @category Class
 * @package  RoyalMail\ClickAndDrop\Rest\Api
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SenderDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SenderDetailsRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tradingName']) && (mb_strlen($this->container['tradingName']) > 250)) {
            $invalidProperties[] = "invalid value for 'tradingName', the character length must be smaller than or equal to 250.";
        }
    ...
    {
        if (!is_null($tradingName) && (mb_strlen($tradingName) > 250)) {
            throw new \InvalidArgumentException('invalid length for $tradingName when calling SenderDetailsRequest., must be smaller than or equal to 250.');
        }
    ...
    public function setPhoneNumber($phoneNumber)
    {
        if (!is_null($phoneNumber) && (mb_strlen($phoneNumber) > 25)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling SenderDetailsRequest., must be smaller than or equal to 25.');
        }
    ...
    public function setEmailAddress($emailAddress)
    {
        if (!is_null($emailAddress) && (mb_strlen($emailAddress) > 254)) {
            throw new \InvalidArgumentException('invalid length for $emailAddress when calling SenderDetailsRequest., must be smaller than or equal to 254.');
        }
