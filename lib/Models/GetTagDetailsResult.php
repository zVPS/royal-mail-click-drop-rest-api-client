...
/**
 * GetTagDetailsResult Class Doc Comment
 *
 * @category Class
 * @package  RoyalMail\ClickAndDrop\Rest\Api
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetTagDetailsResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetTagDetailsResult';
    ...
    public function setKey($key)
    {
        if (!is_null($key) && (mb_strlen($key) > 100)) {
            throw new \InvalidArgumentException('invalid length for $key when calling GetTagDetailsResult., must be smaller than or equal to 100.');
        }
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 100)) {
            throw new \InvalidArgumentException('invalid length for $value when calling GetTagDetailsResult., must be smaller than or equal to 100.');
        }
